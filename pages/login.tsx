        ...
        <div className="flex flex-wrap justify-center items-center  min-h-screen bg-sign-in-back">
            <div className="-mt-10">
                ...
                <div className="flex flex-col items-center w-full sm:w-435">
                    <div className="">
                        <div className="pt-5 w-full max-w-full sm:w-435">
                            <input className="py-2 px-6 w-full rounded-md focus:outline-none bg-gray-100  text-gray-900 focus:bg-gray-300" placeholder="Email" type="text" />
                        </div>
                        <div className="pt-5 w-full max-w-full sm:w-435">
                            <input className="py-2 px-6 w-full rounded-md focus:outline-none bg-gray-100  text-gray-900 focus:bg-gray-300" placeholder="Password" type="password" />
                        </div>
                    </div>
                    ...
                    <div className="flex mt-12">
                        ...
                        <h3 className="text-gray-400 text-center text-sm px-2 hover:text-blue-600">Sign up</h3>
                    </div>
                </div>
            </div>
