...
export default function Login(){
    return(
        <div className="flex justify-center items-center max-w-5xl min-h-screen mx-auto bg-gray-500">
            <div className="flex-col px-7 self-center">
                ...
                <div className="pt-5 flex flex-col">
                    <input className="w-full py-2 px-4 rounded-md" placeholder="Email" type="text" />
                </div>
                <div className="pt-5 flex flex-col">
                    <input className="w-full py-2 px-4 rounded-md" placeholder="Password" type="password" />
                </div>

                <div className="flex flex-col self-center">
                    <button className="bg-red-600 rounded-md px-4 py-4">
                        Sign In
                    </button>
                </div>
            </div>
