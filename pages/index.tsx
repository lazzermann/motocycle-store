...
export default function Home() {
  return (
    <div id="app" className="min-h-screen bg-white antialiased">
      <header>
        <div className="flex justify-between px-2 py-2">
          ...
          <div className="flex mt-4 mr-2">
            ...
            <div className="pr-4">
              <button type="button"> {/*Add link to add moto page*/}
                <svg className="w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 52 52"><path d="M26 0C11.664 0 0 11.663 0 26s11.664 26 26 26 26-11.663 26-26S40.336 0 26 0zm0 50C12.767 50 2 39.233 2 26S12.767 2 26 2s24 10.767 24 24-10.767 24-24 24z"/><path d="M38.5 25H27V14a1 1 0 10-2 0v11H13.5a1 1 0 100 2H25v12a1 1 0 102 0V27h11.5a1 1 0 100-2z"/></svg>
              </button>
            </div>
        ...
        <nav className="">
          <div className="block">
            <div className="bg-white px-4 py-3 border-t-8 border-gray-200">
              <span className="font-bold text-xl ">Sellers</span>
            </div>
              ...
              <div className="border-t border-gray-200">
                  <Link href="/test">
                    <div className="flex justify-between pr-4 pl-6 py-3">
                        <a className="flex justify-between" href="">
                          <svg className="w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 52 52"><path d="M26 0C11.664 0 0 11.663 0 26s11.664 26 26 26 26-11.663 26-26S40.336 0 26 0zm0 50C12.767 50 2 39.233 2 26S12.767 2 26 2s24 10.767 24 24-10.767 24-24 24z"/><path d="M38.5 25H27V14a1 1 0 10-2 0v11H13.5a1 1 0 100 2H25v12a1 1 0 102 0V27h11.5a1 1 0 100-2z"/></svg>
                          <span className="pl-4">Add advert</span>
                        </a>
